...
// Change the sender name in WordPress emails
function custom_wp_mail_from_name($name) {
    return 'Geb & Nut Support'; // Replace with your desired sender name
}
add_filter('wp_mail_from_name', 'custom_wp_mail_from_name');

// Change the sender email in WordPress emails
function custom_wp_mail_from($email) {
    return 'noreply@gebandnut-tours.com'; // Replace with your desired sender email address
}
