<?php 
if ( ! function_exists( 'travelfic_google_fonts_list' ) ) {
	function travelfic_google_fonts_list(){
        $fonts_array = array (
            'ABeeZee' => 'ABeeZee',
            'Abel' => 'Abel',
...
if ( ! function_exists( 'travelfic_google_fonts_scriptss' ) ) {
    function travelfic_google_fonts_scriptss() {
        $prefix = 'travelfic_customizer_settings_';
        $travelfic_heading_font_family = get_theme_mod($prefix.'heading_font_family', '');
        $travelfic_body_font_family = get_theme_mod($prefix.'body_font_family', '');
        if( !empty($travelfic_heading_font_family) ){
            $heading_url = 'https://fonts.googleapis.com/css2?family='. str_replace("_","+",$travelfic_heading_font_family) .':wght@100;200;300;400;500;600;700;800;900&display=swap';
            wp_enqueue_style( 'travelfic-google-'.$travelfic_heading_font_family, $heading_url, array(), '' );
        }
        
        if( !empty($travelfic_body_font_family) ){
            $body_url = 'https://fonts.googleapis.com/css2?family='. str_replace("_","+",$travelfic_body_font_family) .':wght@100;200;300;400;500;600;700;800;900&display=swap';
            wp_enqueue_style( 'travelfic-google-'.$travelfic_body_font_family, $body_url, array(), '' );
        }
    }
}
add_action( 'wp_enqueue_scripts', 'travelfic_google_fonts_scriptss', 9999999 );