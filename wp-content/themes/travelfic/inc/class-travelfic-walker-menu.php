<?php
if (!class_exists('Travelfic_Custom_Nav_Walker')) {
class Travelfic_Custom_Nav_Walker extends Walker_Nav_Menu { 
	...
	public function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0) { 
		...
		$item_output .= (is_object($args) && $args->has_children) ? ' <div class="travelfic-dropdown"> ' : '';
