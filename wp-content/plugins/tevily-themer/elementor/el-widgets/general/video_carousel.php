...
class GVAElement_Video_Carousel extends GVAElement_Base{
   ...
   public function get_name(){
	...
	public function get_title() {
		return __('Video Carousel', 'tevily-themer');
	}
	...
	protected function register_controls() {
		...
		$repeater = new Repeater();
	  	...
	  	$repeater->add_control(
			'video_link',
			[
				 'label'   => __('Video Link', 'tevily-themer'),
				 'default' => 'https://www.youtube.com/watch?v=knTiUD5IAww',
				 'type'    => Controls_Manager::TEXT,
				 'description' => esc_html__( 'You can add youtube/vimeo video link', 'tevily-themer' )
			]
	  	);
	  	...
	  	$this->add_control(
			'videos_content',
			[
				 'label'       => __('Video Content', 'tevily-themer'),
